...
public class Spout extends RubyObject implements IRichSpout {
    ...
    static {
        String source = new StringBuilder("require 'java'\n" +
            ...
            "end\n" +
            "").toString();
        __ruby__.executeScript(source, "/Users/dev/.rvm/gems/jruby-1.7.12/gems/redstorm-0.6.6/lib/red_storm/proxy/spout.rb");
    ...
    public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
        ...
        IRubyObject ruby_result = Helpers.invoke(__ruby__.getCurrentContext(), this, "open", ruby_arg_conf, ruby_arg_context, ruby_arg_collector);
        return;
    ...
    public void ack(Object msg_id) {
        IRubyObject ruby_arg_msg_id = JavaUtil.convertJavaToRuby(__ruby__, msg_id);
        IRubyObject ruby_result = Helpers.invoke(__ruby__.getCurrentContext(), this, "ack", ruby_arg_msg_id);
        return;
    ...
    public void fail(Object msg_id) {
        IRubyObject ruby_arg_msg_id = JavaUtil.convertJavaToRuby(__ruby__, msg_id);
        IRubyObject ruby_result = Helpers.invoke(__ruby__.getCurrentContext(), this, "fail", ruby_arg_msg_id);
        return;
